...
Status: accepted for v0.1 by `ARC-07`  
...
6. Enforce evidence-tier behavior from `SUCCESS_CRITERIA.md`; 0–4 tasks allow suggestions only and no proven-improvement claim.
