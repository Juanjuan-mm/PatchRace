...
- Updated dependencies
  ...
  - @patchrace/adapters@0.1.0
  - @patchrace/tasks@0.1.0
  - @patchrace/diagnosis@0.1.0
  - @patchrace/optimizer@0.1.0
  - @patchrace/report@0.1.0

## 0.1.0-rc.2

### Patch Changes

- Stop successful trials from receiving a failure-diagnosis finding. Passing
  trials now retain their deterministic facts with zero findings and an explicit
  no-failure-to-diagnose limitation.
- Updated dependencies
  - @patchrace/diagnosis@0.1.0-rc.2
  - @patchrace/contracts@0.1.0-rc.2
  - @patchrace/core@0.1.0-rc.2
  - @patchrace/adapters@0.1.0-rc.2
  - @patchrace/tasks@0.1.0-rc.2
  - @patchrace/optimizer@0.1.0-rc.2
  - @patchrace/report@0.1.0-rc.2
